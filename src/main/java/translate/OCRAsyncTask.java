...
public class OCRAsyncTask  {
    ...
    public OCRAsyncTask( String apiKey, boolean isOverlayRequired, String imageUrl, String language) {
        this.mApiKey = apiKey;
    ...
    String sendPost(String apiKey, boolean isOverlayRequired, String imageUrl, String language) throws Exception {
